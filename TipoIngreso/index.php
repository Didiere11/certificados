          ...
          <div class="col s12 m8 offset-m2">
              <div class="card">
                    ...
                    <div class="card-content">
                        <span class="card-title">Tipo de Ingreso</span>
                        <table id="dtTable" class="higlight bordered dataTable">
                            <thead>
                                <tr><th>Tipo de Ingreso</th><th></th></tr>
                            </thead>
                            <tbody>
                                <?php
      ...
      <form id="formulario" method="post">
         <div class="row">
            <div class="input-field_col_s12">
                    <input type="hidden" name="idingr" id="idingr">
                    <input type="text" name="ingreso" id="ingreso" class="validate">
