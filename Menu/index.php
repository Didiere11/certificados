        ...
        <form id="formulario" method="post">
            <div class="row">
                <div class="input-field_col_s12">
                    ...
                    <label for="idm">Identificador Menu:</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field_col_s12">
                    <input type="text" name="nomm" id="nomm" class="validate">
                    <label for="nomm">Nombre del Menu:</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field_col_s12">
                    <input type="text" name="orden" id="orden" class="validate">
                    <label for="orden">Orden del Menu:</label>
                </div>
            </div>
        </form>
    </div>
